...
import com.example.mastergame.funcionesPrincipales.ReproductordeVideoUActivity
import com.example.mastergame.databinding.ProfileVideoItemRowBinding
    ...
    inner class VideoViewHolder(private val binding: ProfileVideoItemRowBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(video: VideoModel) {
            ...
            binding.thumbnailImageView.setOnClickListener{
                val intent = Intent (binding.thumbnailImageView.context,
                    ReproductordeVideoUActivity::class.java)
